# В терминал для создания .exe в папке dist
pyinstaller --onefile --console Management/acc_reg_data.py
...
FILE_NAME = os.path.join(os.getcwd(), "Management/acc_reg_data_test7.xlsx")
